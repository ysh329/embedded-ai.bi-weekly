...
机器之心
https://mp.weixin.qq.com/s/hOfdyUH4AhUA1rmkZprVIQ
...
近日谷歌发布博客，介绍了新一代定向人声分离系统 VoiceFilter-Lite。该方法同样基于谷歌的声纹识别技术，但只需要 2.2MB 大小的模型，就能将重叠语音的词错率（word error rate）降低 25.1%。该模型能够用于设备端语音识别，从而让用户在没有网络连接的情况下，也能在嘈杂的背景噪声环境下使用语音助手。
