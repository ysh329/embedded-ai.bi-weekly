...
导读：本次内容20条，关于BERT有4条。「业界新闻」搜狗的手机AR实景导航挺有意思，其中「论文」三篇BERT量化/加速方面的文章，「开源项目」基于端MNN的上层SDK MNNKit、浏览器端BLAS库值得关注，「博文」关于兼顾速度精度与工程实现的CNN结构设计的技巧值的一看，以及TFLITE端侧基于部分层训练的迁移学习实战！
