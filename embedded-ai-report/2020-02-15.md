...
- [百度宣布免费开源业内首个口罩人脸检测及分类模型 |]()
项目：
摘要：2月13日，百度宣布免费开源业内首个口罩人脸检测及分类模型。该模型可以有效检测在密集人流区域中携带和未携戴口罩的所有人脸，同时判断出他们是否佩戴口罩。广大开发者和企业厂商可通过免费开源的 AI 模型，快速完成软件开发。  
...
- [在MCU上实现AI深度学习 | 嵌入式资讯精选](https://mp.weixin.qq.com/s/rbfVQyUFnCBcIJwp0Cnw7g)  
