...
- [最近联发科也向台积电追加了很多5nm的芯片订单，猜测华为可能会使用联发科的芯片](https://mp.weixin.qq.com/s/OwY68oZUie8WQuQeMc2CGg);
...
- [高通发布全新处理器 为智能手表而生
安兔兔
https://mp.weixin.qq.com/s/FUQ1AvbdV0PsVaGXT3IuoA
6月30日深夜，高通召开发布会，正式推出了骁龙Wear 4100系列处理器，包括骁龙Wear 4100和骁龙Wear 4100 Plus两款产品，从命名上就可以看出，该处理器将主要应用于智能手表设备上。
...
- [2006.14090v1] [Neural Architecture Design for GPU-Efficient Networks](https://arxiv.org/abs/2006.14090v1)  
...
- [rogerou/Arm-neon-intrinsics: arm neon 相关文档和指令意义](https://github.com/rogerou/Arm-neon-intrinsics)  
摘要：arm neon 方面的文档少，本项目整理intrinsics指令的内容和文档。  
