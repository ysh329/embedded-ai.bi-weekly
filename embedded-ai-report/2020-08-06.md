...
摘要：抖音短视频中的大眼特效有很多人玩，这篇就讲一下怎么实现。本文为《抖音美颜效果开源实现，从AI到美颜全流程讲解》姐妹篇，很多代码和内容都类似,看过的同学可以直接看源码。大眼特效原理的美颜差不多，都是AI和计算机图形学的结合。美颜是的基本原理就是深度学习加计算机图形学。深度学习用来人脸检测和人脸关键点检测。计算机图形学用来磨皮，瘦脸和画妆容。一般在Android上使用OpenGLES，IOS为Metal。  
