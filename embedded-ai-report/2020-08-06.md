...
- Arm中国对「换帅门」事件再次发布了公开信。信中指出了Arm英国和厚朴投资威胁员工和客户的罪行。Arm中国官方微博同时呼吁地方政府机构能够关注；
- 英特尔更新[Intel® Architecture Instruction Set Extensions Programming Reference](https://software.intel.com/content/www/us/en/develop/download/intel-architecture-instruction-set-extensions-programming-reference.html)，AMX矩阵计算ISA马上就来了；
- 负责英特尔几乎所有硬件的高管、英特尔首席工程官Venkata “Murthy" Renduchintala将于8月3日离职，其领导的技术、系统架构和客户部门（TSCG）将拆分为5个团队；
- 英特尔今天在2020年第二季度财报中宣布，现将其7nm CPU的发布相较此前拟定日期推迟了6个月，这很可能将导致了其路线图的延迟。CEO Bob Swan介绍，因一种“缺陷模式”，其7nm工艺的产量已比公司内部目标落后了12个月，但英特尔已从根本上解决了这个问题，并已投资“应急计划”；
- iPhone 12系列将采用A14处理器，台积电5nm制程。A14可能会内置125亿个晶体管，性能更强、功耗更低，其它特性依然刘海屏、20W快充、6GB内存，大概率还是60Hz刷新率的屏幕；
- 联发科预计明年二季度推出下一代的5G旗舰智能手机处理器天玑2000，工艺和性能方面提升，基于5nm工艺，并改善5G网络；
- 7月23日，联发科最新的5G SoC——天玑720，采用八核CPU，包含两个主频为2GHz的Arm Cortex-A76大核。集成 MediaTek APU（AI 处理器）及 AI 相机增强功能。支持90Hz屏幕刷新率。搭载了Arm Mali G57 GPU、LPDDR4X内存和UFS 2.2闪存；
- 高通宣布与华为的法律纠纷已解决，且和华为签署了新的长期专利许可协议，华为将成为5G手机和网络设备的主要供应商。虽仍被禁止购买高通芯片，但已恢复支付无线技术的许可费用；
- 按照惯例，华为新一代芯片将于9月发布，随后首发搭载于华为Mate系列新旗舰。新一代麒麟芯片有望命名为麒麟1020，台积电5nm工艺。成本介于苹果A14与Apple ARM CPU之间。
- 7月30日，第三方调研机构Canalys发布了2020年第二季度全球智能手机市场报告。二季度华为智能手机出货5580万台，首次超越了三星，成为冠军。
