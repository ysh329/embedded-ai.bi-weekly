...
- 英特尔方面。硬件高管和首席工程师离职；7nm CPU发布推迟6个月；更新[Intel® Architecture Instruction Set Extensions Programming Reference](https://software.intel.com/content/www/us/en/develop/download/intel-architecture-instruction-set-extensions-programming-reference.html)，AMX矩阵计算ISA马上就来了；
- iPhone 12系列将采用A14处理器，台积电5nm制程。A14可能会内置125亿个晶体管，性能更强、功耗更低，大概率60Hz刷新率屏幕；
