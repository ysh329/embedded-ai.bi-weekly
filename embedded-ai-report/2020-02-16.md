...
> 导读：ARM 发布 Cortex-M55 和 Ethos-U55 系列，适合语音AI模型推理、NXP工程师也在 MCU 上实现人脸识别、性别识别。小米10系列和三星Galaxy S20系列发布
...
摘要：DISCLAIMER: This is an early phase project that we hope will graduate into a supported form someday, but it is far from ready for everyday use and is made available without any support.  
