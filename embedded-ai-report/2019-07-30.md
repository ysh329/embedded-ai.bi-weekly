...
- [联通IoT全球布局的“野心”，Arm给了一臂之力 | 雷锋网](https://mp.weixin.qq.com/s/DE13eBFoqT2iikLH7lJLmg)  
摘要：Arm与联通物联网有限公司宣布双方合作，Arm已成功部署基于Arm Pelion设备管理平台与Mbed OS操作系统所打造的全新物联网平台，形成「Arm Mbed OS+Arm Pelion+联通物联网平台」的组合模式，融合Arm在芯片侧、设备层的能力与联通在网络层的能力，意欲构建行业通用物联网平平台。  
Arm Mbed OS是Arm在2014年10月对外公布的物联网操作系统，基于ARM Cortex-M处理器的设备所设计的免费操作系统，配有安全、通讯和设备管理模块，支持蓝牙、2G、3G与CDMA通信技术、Thread、Wi-Fi、802.15.4/6LoWPAN、TLS/DTLS、CoAP、HTTP、MQTT以及轻量级的M2M。只需要32-64kb RAM和256 kb ROM的配置，适用于小型低功耗物联网设备。
