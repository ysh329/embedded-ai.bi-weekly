...
> 导读：近来的大新闻，可能要数国内框架开源：[清华大学计算机图形学组的Jittor]()、[旷视动态图和静态图合一且训练推理一体的MegEngine（ARM部分6月开源）](https://mp.weixin.qq.com/s/wGGFZJOxgJVzf30ZrfI2lQ)、[华为自动实现分布式并行训练的MindSpore](https://mp.weixin.qq.com/s/fgGOtAxLmP0huZOrE5m74w)及其最近推出的完整解决方案平台[华为云ModelArts Pro](https://mp.weixin.qq.com/s/CfFVxD6fYKA-J9tka4eg2g)，还有今年上半年将要开源的OneFlow。
...
链接：https://arxiv.org/pdf/2003.13678.pdf  
